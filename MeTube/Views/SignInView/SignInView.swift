        ...
        ZStack {
            ...
            VStack {
                ...
                Text("Register your Account")
                    ...
                    .offset(y: -80)
                SignInTFView(input: $fbViewModel.email, accExist: $fbViewModel.accExist, accAccepted: $fbViewModel.accAccepted)
                    .offset(y: -80)
                SignInPWView(input: $fbViewModel.password, accExist: $fbViewModel.accExist, accAccepted: $fbViewModel.accAccepted)
                    .offset(y: -80)
